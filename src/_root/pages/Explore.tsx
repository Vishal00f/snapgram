...
function Explore() {
  ...
  //to avoid refetching again and again we are using debouncing
    ...
    <div className='explore-container'>
      ...
      <div className='flex-between w-full max-w-5xl mt-16 mb-7'>
        ...
        <div className="flex-center gap-3 bg-dark-3 rounded-xl px-4 py-2 cursor-pointer">
          <p className='smaall-medium md:base-medium text-light-2'>All</p>
      ...
      <div className="flex flex-wrap gap-9 w-full max-w-5xl">
        ...
        />
      ) : shouldShowPosts ? (<p className='text-light-4 mt-10 text-center w-full'>End of Posts</p>) : posts.pages.map((item, index) => (
          <PostListGrid key={`page-${index}`} posts={item.documents} />
        ))}
      </div>
      {hasNextPage && !searchValue &&(
        //once we get bottom of the page
